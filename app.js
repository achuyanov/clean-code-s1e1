...
let incompleteTaskHolder = document.getElementById("todo-section"); //ul of #todo-section
let completedTasksHolder = document.getElementById("done-section"); //done-section
...
let taskCompleted = function () {
    ...
    //Append the task list item to the #done-section
    let listItem = this.parentNode;
